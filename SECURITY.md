...
To document a security concern, communication is facilitated with the project curators:
  ...
  - **Method**: Reports are submitted via the repository’s [GitHub Issues](https://github.com/Amey-Thakur/AR-STACK-GAME/issues) interface to formally record security-related findings.
...
## Implementation Context: Unity & ARCore
This project is implemented using the Unity Engine and the Google ARCore SDK, as defined by the project’s technical scope.
